...
public class HttpClient {
  ...
  public static class Builder {
     ...
     *
     * <p>Search domain applies as a suffix for all domain lookups except:
     ...
     *
     * <p>Client uses an exponential backoff policy with jitter.
     ...
     *
     * <p>If delay would exceed the max delay, max delay would be used instead.
     *
     * @return this builder
     */
